  ...
  for (i in 1:N){
    for (t in 1:T_i[i]){
      for (c in 1:C_ti[i,idx_ti[i,t]]){
        Y[i, idx_cti[i,idx_ti[i,t],c], idx_ti[i,t]] ~ normal(mu_y[i, idx_cti[i,idx_ti[i,t],c], idx_ti[i,t]], sigma[c]);
  }}}
...
generated quantities  {
  ...
  for (i in 1:N){
    ...
    for (t in 1:T){
      for (c in 1:C){
        //log_lik[i,idx_cti[i,t,c],idx_ti[i,t]] = normal_lpdf(Y[i,idx_cti[i,t,c],idx_ti[i,t]] | mu_y[i,idx_cti[i,t,c],idx_ti[i,t]], sigma);
